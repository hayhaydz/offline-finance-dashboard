<script lang="ts">
	...
	import { formatTaxWrapper, formatRate, renderProgressBar } from '$lib/utils/formatting';
...
<TransactionFilterBar
	...
	typeFilter={(tx) => tx.type !== 'opening'}
	perPage={10}
	byAccount={data.actual.byAccount}
	title="Tax Year Interest Record"
	emptyMessage="No interest transactions posted yet."
	technicalNote="Running total includes all interest posted since April 6th. Opening balance rows represent the starting state for each account in this tax year."
